...
export default function LoanRowActions({ id, onEdit }: { id: string; onEdit: () => void; }) {
  ...
  const remove = async () => {
    ...
    setConfirmOpen(false);
    if (e) {
      error("Error al eliminar préstamo", e.message);
      return;
    }
  ...
  return (
    <div className="flex gap-2 justify-end">
      ...
      <ConfirmDialog
        ...
        description="Esta acción no se puede deshacer. ¿Deseas eliminar este préstamo?"
      ...
      <ConfirmDialog
        ...
        description="¿Deseas editar la información de este préstamo?"
        confirmText="Editar"
